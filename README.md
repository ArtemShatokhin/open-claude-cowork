...
| **Eigent** | Desktop, local-first multi-agent "Cowork Desktop" built around Spaces, Skills and Connectors | Site states "100% open source" ([eigent.ai](https://www.eigent.ai)) — verify the repo `LICENSE` | Local execution and self-hosted deployment ([eigent.ai](https://www.eigent.ai)) | Model agnostic: cloud, enterprise gateway, or local models, BYOK ([eigent.ai](https://www.eigent.ai)) |
